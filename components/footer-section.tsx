      ...
      <div className="flex flex-col justify-start items-start gap-8 p-4 md:p-8">
        <div className="flex gap-1 items-center justify-center">
          <Image
            ...
            priority // Added priority loading for footer logo
          />
          <div className="text-center text-foreground text-xl font-semibold leading-4">Marro</div>
        </div>

        <p className="text-foreground/90 text-sm font-medium leading-[18px] text-left">
          The AI Client OS made effortless
        </p>
